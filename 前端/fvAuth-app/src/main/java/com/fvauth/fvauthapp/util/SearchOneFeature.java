...
public class SearchOneFeature {
    ...
    //提供给主函数调用的方法
    public static JSONObject doSearchOneFeature(String requestUrl,String APPID,String apiSecret,String apiKey,String AUDIO_PATH,String groupId,String featureId) {
