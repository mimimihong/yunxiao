package com.fvauth.fvauthapp.util;
...
public class CreateFeature {
    ...
    //构造函数,为成员变量赋值
    public CreateFeature(String requestUrl,String APPID,String apiSecret,String apiKey,String AUDIO_PATH,String groupId,String featureId){
    ...
    //提供给主函数调用的方法
    public static JSONObject doCreateFeature(String requestUrl,String APPID,String apiSecret,String apiKey,String AUDIO_PATH,String groupId,String featureId){
        CreateFeature createFeature = new CreateFeature(requestUrl,APPID,apiSecret,apiKey,AUDIO_PATH,groupId,featureId);
